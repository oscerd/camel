...
@UriParams
public class GlacierConfiguration implements Cloneable {
    ...
    @UriParam
    private String amazonGlacierEndpoint;
    @UriParam
    ...
    public void setAmazonGlacierEndpoint(String amazonGlacierEndpoint) {
        this.amazonGlacierEndpoint = amazonGlacierEndpoint;
    }
